...
* Ensure all data for a month is reported within 10 calendar days following the end of the reporting period.
...
Operating Office is the sole receiver of all End User Statistics Reports
sent by SPs.
