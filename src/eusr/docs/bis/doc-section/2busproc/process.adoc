...
The following subsets MAY be provided for **receiving end users only** to be compliant to this specification:
...
** An End User Statistics Report MUST be transmitted within 16 calendar days (inclusive) after the end of the previous Reporting Period.
