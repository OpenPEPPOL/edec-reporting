  ...
  <pattern id="default">
    ...
    <rule context="/eur:EndUserReport/eur:EndUser/eur:Country | /eur:EndUserReport/eur:EndUser/eur:Intermediary/eur:Country">
      <assert id="BR-EUR-12" flag="fatal" test="not(contains(normalize-space(.), ' ')) and 
        ...
        >[BR-EUR-12] The country code MUST be coded with ISO code ISO 3166-1 alpha-2 by which the country of issue may be identified. Nevertheless, Greece may use the code 'EL', Kosovo may use the code 'XK'.</assert>
    </rule>
  </pattern>
</schema>
