...
*** All Dataset Type identifiers the End User has sent during the reporting period
*** All Dataset Type identifiers the End User has received during the reporting period
