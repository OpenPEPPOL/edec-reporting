...
An End User Report contains subtotals per distinct pairs of Dataset Type and Process ID.
...
This subtotal is the only type that is currently supported by End User Report BIS.
