...
1.	Automatically check which providers have not submitted their End User Report. This check will be triggered automatically.
...
2.	Process the received data to generate reports for different jurisdictions and/or Peppol Authorities.
...
All messages contains ProcessID and CustomizationID. ProcessID identifies what business process a given message is part of, and CustomizationID identifies the kind of message and the rules applied.
...
CustomizationID is a string without spaces.
...
include::./technical/codelists/index.adoc[]

:leveloffset: -1

:leveloffset: +1

include::./technical/description/index.adoc[]

:leveloffset: -1

:leveloffset: +1

include::./technical/businessrules/index.adoc[]
