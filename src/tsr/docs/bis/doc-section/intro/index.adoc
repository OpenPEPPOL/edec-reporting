...
Transaction Statistics reporting of production data helps the Peppol Coordinating Authority (PCA) and Peppol Authorities (PAs)
...
This operational procedure will explain and outline the operational procedures for the Transaction Statistics Reporting.
