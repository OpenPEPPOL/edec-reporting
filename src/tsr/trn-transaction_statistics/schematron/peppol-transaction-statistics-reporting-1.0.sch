...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern id="default">
    ...
    <rule context="/tsr:TransactionStatisticsReport">
      ...
      >[TSR-03] The subtotals per $name_tp MUST exist
      </assert>
      ...
      >[TSR-07] The subtotals per $name_spdtpr MUST exist
      </assert>
    ...
    <rule context="/tsr:TransactionStatisticsReport/tsr:Subtotal/tsr:Key[normalize-space(@schemeID) = 'SenderCountry' or 
      ...
      >[TSR-20] The country code MUST be coded with ISO code ISO 3166-1 alpha-2. Nevertheless, Greece may use the code 'EL', Kosovo may use the code 'XK' or '1A'.
      </assert>
    </rule>
